...
const ModalFormularioTarea = () => {
    ...
    //Para setear el formulario cuando se da click en editar
    useEffect(()=> {
        if(tarea?._id){
            setId(tarea._id)
                    ...
                    >
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    <Dialog.Title as="h1" className="text-2xl leading-6 font-bold text-gray-900">
                                        ...
                                        <form 
                                            ...
                                            <input 
                                                type="submit"
                                                className='bg-sky-600 hover:bg-sky-800 text-white text-center uppercase rounded font-bold text-sm cursor-pointer transition-colors w-full p-2 '
